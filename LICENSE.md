...
6.1 New Versions.
AnyMessage.io ("AnyMessage") may publish revised and/or new versions of the
...
License published by AnyMessage. No one other than AnyMessage has the right to
modify the terms applicable to Covered Code created under this License.

6.3 Derivative Works.
If You create or use a modified version of this License (which you may only do
in order to apply it to code which is not already Covered Code governed by this
License), You must (a) rename Your license so that the phrases "AnyMessage",
...
https://opensource.org/licenses/CPAL-1.0. The License is based on the Mozilla Public
...
The Original Code is AnyMessage
The Initial Developer of the Original Code is Daniel Eric Sandoval All portions
of the code are Copyright (c) 2018 Daniel Eric Sandoval All Rights Reserved.
...
Attribution Copyright Notice: Copyright (c) 2018 Daniel Eric Sandoval
Attribution Phrase (not exceeding 10 words): Powered by AnyMessage
Attribution URL: http://www.AnyMessage.io
Graphic Image provided in the Covered Code as file:
https://github.com/d3sandoval/anymessage/blob/master/ui/static/android-chrome-512x512.png
